...
class FTUNetFormer(nn.Module):
    ...
    def __init__(self,
        ...
        self.backbone = SwinTransformer(in_chans=channels, embed_dim=embed_dim, depths=depths, num_heads=num_heads, frozen_stages=freeze_stages)
        encoder_channels = [embed_dim, embed_dim*2, embed_dim*4, embed_dim*8]
        self.decoder = Decoder(encoder_channels, decode_channels, dropout, window_size, num_labels)
